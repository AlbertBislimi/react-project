  ...
  <div name='portfolio' className='w-full mt-20'>
      ...
      <div className='max-w-[1240px] mx-auto relative'>
          <div className='px-4 py-10'>
              ...
              <p className='py-4 text-lg font-light mx-56 text-black text-center'>all projects that we have already done, proven can help to use more comfortable, then can used by client from our business.</p>
          </div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-x-8 gap-y-16 px-4 pt-10 sm:pt-10 text-black'>
            ...
            <div className='relative'>
              ...
              <h1 class="absolute text-xl font-medium text-white bottom-10 left-8">Cloud App</h1>
            </div> 
            <div className='relative'>
