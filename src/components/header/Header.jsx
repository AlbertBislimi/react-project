...
const Header = () => {
  return (
    <div id="home" className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 dark:bg-black">
        ...
        <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-white">when you need us for improve your business,
