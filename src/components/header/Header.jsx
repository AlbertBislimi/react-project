...
const Header = () => {
  return (
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        <h1 className="mb-4 font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Make your dream 
            <br/>business goal come true</h1>
        <p className="mb-[10px] text-[16px] font-[300] text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">when you need us for improve your business,<br/>
