...
const Nav = () => {
  ...
  return (
      <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-black transition duration-500">
        ...
        <button onClick={() => setTheme(colorTheme)} id="theme-toggle" type="button" className="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none rounded-lg text-sm p-2.5">
          {colorTheme === "light" ? (
          <svg 
