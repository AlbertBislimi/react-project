            ...
            <div className="flex-initial lg:w-[50%] w-full sm:p-[20px] lg:relative">
              <div className="text-center mx-auto max-w-screen-xl lg:flex lg:mt-5 lg:p-100px lg:flex-col lg:justify-center lg:gap-y-6 px-5">
                ...
                <div className="flex justify-center"> 
                  <button type="button" className="mb-10 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-full text-sm px-5 py-2.5 text-center mt-5 w-[50%] lg:w-40">About Us</button>
