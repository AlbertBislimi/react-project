  ...
  <div  className='w-full mt-10'>
      ...
      <div className='max-w-[1240px] mx-auto relative lg:py-10 lg:px-12 lg:h-50'>
          <div className='mx-auto max-w-screen-xl text-center'>
              ...
              <h3 className='text-3xl font-bold sm:text-5xl text-black text-center'>Our Teammate</h3>
          </div>

          <div className="lg:flex flex-row-reverse align-middle lg:bg-white lg:mt-5">
            <div className="flex-initial lg:w-[50%] w-full sm:p-[20px] lg:relative">
              <div className="text-center mx-auto max-w-screen-xl lg:flex lg:mt-5 lg:p-100px lg:flex-col lg:justify-center lg:gap-y-6 px-5">
                <p className='lg:text-left mb-2 text-left	text-gray-500'>We move with make a Creative Strategy for help your business goal, we help to improve your income by a services we have. make your content look interesting and make people look for your business.<br/><br/> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eu neque tempor at ut auctor maecenas,Lorem ipsum d</p>
                <div className="flex justify-between"> 
                  <button type="button" className="mb-10 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-full text-sm px-5 py-2.5 text-center mt-5 w-[100%] lg:w-40">About Us</button>
