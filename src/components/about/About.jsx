...
const About = () => {
  return (
   <div name="a" className="flex-col py-8 px-4 mx-auto  text-center lg:text-ellipsis lg:mr-7 lg:w-full lg:flex-row lg:h-screen lg:flex  lg:items-center" >
    <div name="right" className=" lg:float-right lg:px-9"> 
   ...
   <p className="mb-8 text-lg text-left font-normal  text-gray-500  lg:text-justify sm:px-16 xl:px-48 lg:text-lg">
  ...
  <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-8 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ">About Us</button>
    ...
    <img
      src={Aboutus}
      alt=""
      className="lg:shrink md:shrink lg:w-3/5 md:w-auto md:ml-10 lg:object-cover"
    />
