  ...
  return (
    ...
    <div className="lg:flex lg:h-screen lg:bg-white " id='o'>
      <div className=" mt-10 lg:flex lg:flex-1 lg:items-center lg:justify-center" id='left'>
        <div id='left-wrapper' className="text-center lg:flex lg:w-3/5 lg:h-4/5 lg:p-100px lg:flex-col lg:justify-center lg:gap-y-6 lg:text-left">
          ...
          <p className='lg:text-left md:px-10 mb-4 text-gray-500'>We move with make a Creative Strategy for help your business goal, we help to improve your income by a services we have. make your content look interesting and make people look for your business</p>
      ...
      <div className=" lg:flex-1 lg:relative" id='right'>
        <div id='cards' className="flex flex-wrap items-center justify-center md:gap-x-6  lg:flex lg:flex-wrap lg:w-10/12 lg:h-4/5  lg:justify-between lg:gap-8 lg:mt-20 lg:overflow-hidden">
