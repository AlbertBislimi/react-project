...
const OurServices = () => {
  return (
    ...
    <div id="services" className="lg:flex px-[100px] lg:bg-white dark:bg-black">
      ...
      <div className="flex max-w-4xl mx-auto items-center lg:flex-1 lg:items-center lg:justify-center">
        <div className="text-center py-4 px-4 mx-auto lg:flex lg:w-[85%] lg:h-4/5 lg:flex-col lg:justify-center lg:gap-y-6">
          <h3 className="text-xl pt-8 lg:text-left lg:font-light text-blue-600 dark:text-white">Our Services</h3>
          <h2 className="text-3xl font-bold lg:text-left xl:text-6xl py-2 sm:text-5xl text-black dark:text-white">Perfect and fast Movement</h2>
          <p className='text-xl lg:text-left mb-4 text-gray-500 dark:text-white'>We move with make a Creative Strategy for help your business goal, we help to improve your income by a services we have. make your content look interesting and make people look for your business</p>
          <button type="button" className="inline-flex justify-end font-medium text-blue-600 hover:underline dark:text-white">Read More<svg aria-hidden="true" class="ml-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg></button>
        </div>
      </div>
