  ...
  return (
    ...
    <div className="lg:flex lg:h-screen lg:bg-white">
      <div className="flex lg:flex-1 lg:items-center lg:justify-center">
        <div className="text-center py-4 px-4 mx-auto lg:flex lg:w-3/5 lg:h-4/5 lg:flex-col lg:justify-center lg:gap-y-6">
          <h3 className="text-xl pt-8 mb-2 lg:text-left lg:text-3xl lg:font-light text-blue-600">Our Services</h3>
          <h2 className="text-3xl text-bold lg:text-left xl:text-6xl py-2 sm:text-5xl text-black">Perfect and fast Movement</h2>
