    ...
    <div id="services" className="lg:flex pt-[100px] lg:bg-white dark:bg-black">
      ...
      <div className="flex mx-auto items-center lg:flex-1 lg:items-center lg:justify-center">
        ...
        <div className="text-center flex-col justify-center items-center py-4 mx-auto lg:flex lg:w-[85%] lg:h-4/5 lg:flex-col lg:justify-center lg:gap-y-6">
          ...
          <h2 className="text-[27px] font-[700] leading-[33px] pt-[10px] lg:text-left xl:text-6xl sm:text-5xl text-black mr-auto dark:text-white">Modernize your <br/> hiring process</h2>
      ...
      <div className="py-8 flex max-w-4xl mx-auto items-center">
        <div className="grid grid-cols-1 gap-4 mx-auto sm:grid-cols-2 md:gap-x-8 lg:overflow-hidden lg:mt-20">
          <a href="/#" className=" mb-4 p-6 w-64 h-64  bg-white rounded-3xl border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-[#0B0F15] dark:border-gray-700 dark:hover:bg-gray-900">
            ...
            <h5 className="mb-2 mx-8 mt-4 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-center">Register Candiates</h5>
          </a>

          <a href="/#" className=" mb-4 p-6 w-64 h-64 bg-white rounded-3xl border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-[#0B0F15] dark:border-gray-700 dark:hover:bg-gray-900">
            <img src={engine} alt="" className="w-32 mx-10"/>
              <h5 className="mb-2 mx-6 mt-4 text-2xl text-center font-bold tracking-tight text-gray-900 dark:text-white">Register Questionares</h5>
          </a>

          <a href="/#" className=" mb-4 p-6 w-64 h-64  bg-white rounded-3xl border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-[#0B0F15] dark:border-gray-700 dark:hover:bg-gray-900">
            <img src={design} alt="" className="w-32 mx-10"/>
            <h5 className="ml-16 mb-2 mx-8 mt-4 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Interview Timeline</h5>
          </a>
          ...
          <a href="/#" className="block p-6 w-64 h-64  bg-white rounded-3xl border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-[#0B0F15] dark:border-gray-700 dark:hover:bg-gray-900">
            ...
            <h5 className="ml-16 mb-2 mx-8 mt-4 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Rating System</h5>
          </a>
