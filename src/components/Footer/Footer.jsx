...
const Footer = () => {
    return (
        ...
        <div className="p-4 bg-gray-800 sm:p-6 dark:bg-gray-900">
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    <a href="/#" className="flex items-center">
                        <img src={agency} className="sm:w-full lg:w-full" alt="Agency Logo"></img>
                    </a>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 className="mb-6 text-md font-semibold text-white dark:text-white">Terms &amp; policies</h2>
                    ...
                    <div>
                        <h2 className="mb-6 text-md font-semibold text-white dark:text-white">Company</h2>
                        <ul className="text-white space-y-4 dark:text-gray-400">
                            <li className="mb-4">
                    ...
                    <div>
                        ...
                        <ul className="text-white dark:text-gray-400">
                            <li className="mb-4">
                                <a href="/#" className="hover:underline">(+62) 893912392190</a>
                            </li>
                            <li>
                                <a href="/#" className="hover:underline">agecnycr@gmail.com</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Location</h2>
                        <ul className="text-white space-y-4 dark:text-gray-400">
                            <li className="mb-4">
                                <p className="hover:underline">PT Osiris Real Estate Internasional</p>
                            </li>
                            <li>
                                <p className="hover:underline">Jl. KH. Wahid Hasyim Kel No.10D</p>
                            </li>
                            <li>
            ...
            <div className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-white sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" className="hover:underline">Agency Creative™</a>. All Rights Reserved.
                    </span>
